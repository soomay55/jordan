...
<div class="container-fluid px-4">
 ...
 <div class="row justify-content-center">
    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header">All Camapiagn</div>
    ...
    <div class="col-md-2">
        <a class="btn btn-success" href="{{route('admin.campaign.create')}}"><i class="bi bi-0-square"></i>Create</a>
    </div>
</div>
