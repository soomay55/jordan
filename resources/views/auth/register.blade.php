                ...
                <div class="row md-3 justify-content-center">
                    <div class="col-md-6">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="check_parent" >
                            <label class="form-check-label" for="check_parent">Register as Child</label>
                          </div>
