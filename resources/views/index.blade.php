                  ...
                  <div class="carousel-cause owl-carousel">
                    ...
                    <div class="item">
                      <div class="cause-entry">
                          <a href="{{route('donation',['id'=>$item->id])}}" class="img" style="background-image: url(images/cause-1.jpg);"></a>
                          <div class="text p-3 p-md-4">
                              <h3><a href="{{route('donation',['id'=>$item->id])}}">{{$item->title}}</a></h3>
                              <p>{{$item->description}}</p>
                              <span class="donation-time mb-3 d-block">Last donation {{\Carbon\Carbon::parse($item->created_at)->diffForHumans()}} </span>
                  <div class="progress custom-progress-success">
                    <div class="progress-bar bg-primary" role="progressbar" style="width: 28%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                  </div>
                  <span class="fund-raised d-block">{{Setting::get('currency_symbol')}}{{$item->available_fund}} raised of{{Setting::get('currency_symbol')}}{{$item->goal}}</span>
                          </div>
                      </div>
                  </div>
                    @endforeach
